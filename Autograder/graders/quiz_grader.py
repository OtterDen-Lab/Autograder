...
class QuizGrader(Grader):
    ...
    def can_grade_submission(self, submission: Submission) -> bool:
        ...
        """
        return isinstance(submission, QuizSubmission) and bool(submission.responses)

    def execute_grading(self, submission: QuizSubmission, *args, **kwargs) -> Dict[str, Any]:
        """
        ...
        for question_id, response_data in submission.responses.items():
            ...
            if question_info:
                ...
                results['response_summary'].append({
                    ...
                    'points': f"{question_analysis['points_earned']}/{question_analysis['points_possible']}",
                    'correct': question_analysis['correct']
                })
    ...
    def score_grading(self, execution_results: Dict[str, Any], *args, **kwargs) -> Feedback:
        ...
        if kwargs.get('detailed_feedback', True):
            ...
            for question_id, analysis in execution_results['question_analysis'].items():
                comments_lines.extend([
        ...
        if percentage >= 90:
            comments_lines.append("Excellent work! You demonstrated strong mastery of the material.")
        elif percentage >= 80:
            comments_lines.append("Good performance! Review any missed questions for improvement.")
        elif percentage >= 70:
            comments_lines.append("Satisfactory work. Consider reviewing the material for better understanding.")
        else:
            comments_lines.append("Please review the material and consider additional practice.")
